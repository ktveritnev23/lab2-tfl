...
Таблица классов эквивалентности для подмножества состояний НКА:

| Префикс/суффикс   | abbbaaaa | bbbaaaa | bbaaaa | baaaa | abaaaa | aaaa | aaa | aa | a | ε |
|-------------------|----------|---------|--------|-------|--------|------|-----|----|---|---|
| **ε**             | +        | -       | -      | -     | -      | -    | -   | -  | - | - |
| **a**             | -        | +       | -      | -     | -      | -    | -   | -  | - | - |
| **ab**            | -        | +       | +      | -     | -      | -    | -   | -  | - | - |
...
Таблица классов эквивалентности для ПКА:

| Префикс/суффикс    | bbb           | a      | aba   | baaba | bbbabba | bbbbabba |
|--------------------|---------------|--------|-------|-------|---------|----------|
| **bbabbaba**       | -             | +      | +     | +     | +       | +        |
| **bbabba**         | -             | -      | +     | +     | +       | +        |
| **bbab**           | -             | -      | -     | +     | +       | +        |
