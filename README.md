...
Для обоснования корректности И-недетерминизма (недопустимости перекрытия между словами из префикса и словами из суффикса) построим таблицу классов эквивалентности для ПКА, где префиксами будут корректные слова из префикса исходной регулярки, а суффиксами - слова из суффикса $ba(a|b)(a|b)a$ исходного регулярного выражения (выбрано $baaba$) без первых символов:

| Префикс/суффикс    | $\varepsilon$ | a      | ba    | aba  | aaba |
|--------------------|---------------|--------|-------|------|------|
| **bbabbaab**       | -             | +      | -     | -    | +    |
| **bbabbaa**        | -             | -      | +     | -    | -    |
| **bbabba**         | -             | -      | -     | +    | -    |
